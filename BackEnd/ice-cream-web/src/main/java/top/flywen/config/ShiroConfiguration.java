...
import top.flywen.config.filter.AjaxAuthenticationFilter;
import top.flywen.config.filter.AjaxAuthorizationFilter;
import top.flywen.config.realm.BaseRealm;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean() {
        ...
        filterChainDefinitionMap.put("/private/login","anon");
        filterChainDefinitionMap.put("/private/register","anon");
